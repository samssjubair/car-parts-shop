  ...
  return (
    <div>
      ...
      <div className="flex justify-center home-input-field-area mt-6 mb-10">
        <div className="w-11/12 car-form-bg-color rounded-lg shadow dark:border md:mt-0  xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            ...
            >
              ...
              <div>
                <input
                  ...
                  name="parts-required"
                  id="parts-required"
                  className="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div className="relative">
                <select
                  ...
                  id="part-type"
                  name="part-type"
                  className="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 pl-2 pr-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 focus:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                >
              ...
              <div>
                <button
                  type="submit"
                  className="home-car-form-btn w-full p-2.5 rounded"
                >
                  Submit
                </button>
              </div>

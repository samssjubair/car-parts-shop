              ...
              <div>
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    rows="5"
                    // cols="100"
                    className="border-gray-300 h-80 px-2 border-2 focus:ring-indigo-500 py-2 text-black focus:border-indigo-500 block w-full shadow-sm sm:text-sm  rounded-md"
                  ></textarea>
                </div>
              </div>
            </form>

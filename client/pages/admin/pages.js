...
const pages = () => {
    ...
    useEffect(()=>{
        axios.get("http://localhost:4800/api/v1/pages")
        .then((response)=>{
          ...
          <tbody className="text-gray-600 text-sm font-light">
            {pages.map((page) => (
              ...
              >
                ...
                <td className="py-3 px-6 text-left">{window.location.host}/{page.route}</td>
                ...
                <td className="py-3 px-6 text-center">{page.createdAt}</td>
                <td className="py-3 px-6 text-center">{page.updatedAt}</td>
                <td className="py-3 px-6 text-center">
                  <button
